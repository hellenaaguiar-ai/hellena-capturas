...
**Desktop** — substitui o Superwhisper: atalho de teclado global com 5
modos (ideia, reflexão, reunião, terapia, aula), gravando microfone e,
quando o modo pede, também o áudio do sistema (para separar "você" de
"outra pessoa" sem diarização) — o modo aula grava só o áudio do sistema,
sem microfone:
...
**Desktop:** aperte `Ctrl+Espaço` (ideia) ou `Ctrl+Alt+D`/`R`/`T`/`A` conforme o modo, fale (exceto no
